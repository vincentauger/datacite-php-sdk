 ...
 */
final readonly class UpdateDOIInput
{
    /**
     ...
     *
     * @throws \InvalidArgumentException If no fields are set
     */
    public function toArray(): array
    {
        ...
        if (empty($data)) {
            throw new \InvalidArgumentException('At least one field must be set for UpdateDOIInput');
        }
